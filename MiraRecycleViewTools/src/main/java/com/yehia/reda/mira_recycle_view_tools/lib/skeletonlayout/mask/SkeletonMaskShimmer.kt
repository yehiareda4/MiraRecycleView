...
import com.yehia.reda.mira_recycle_view_tools.lib.skeletonlayout.isAttachedToWindowCompat
import com.yehia.reda.mira_recycle_view_tools.lib.skeletonlayout.refreshRateInSeconds
...
internal class SkeletonMaskShimmer(
    ...
    override fun start() {
        if (animation == null) {
            animation = Handler(Looper.myLooper()!!)
